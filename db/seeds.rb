ActiveRecord::Base.transaction do
  ...
  songs = [
    ...
    s23 = Song.new(title: "Cat Bui", album_id: ca_dao_me.id, artist_id: dam_vinh_hung.id, url: "https://www.dropbox.com/s/elbd1bnpuatzvhn/CatBui.mp3?dl=1"),
    s24 = Song.new(title: "Diem Xua", album_id: ca_dao_me.id, artist_id: dam_vinh_hung.id, url: "https://www.dropbox.com/s/ka7mq3huk7878mu/DiemXuaDVH.mp3?dl=1"),
